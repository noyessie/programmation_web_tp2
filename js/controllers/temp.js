...
/*applicationModule.controller('addBookController', function($scope, mainFactory) {
    $scope.addBook = function () {
        mainFactory.addBook($scope.newBook);
    }
});

applicationModule.controller('modifyBookController', function($scope, mainFactory) {

    $scope.booksInfos = mainFactory.getBooksInfos();
...
applicationModule.factory("booksFactory" , function(){
    var factory = {
        ...
        },
        {
            ...
            "description": {
                "type": "/type/text",
                "value": "When Stephanie Plum is hired to find a missing child, she begins to wonder if she is working on the right side of the law when events turn suspicious."
            },
            "last_modified": {
                "type": "/type/datetime",
        ...
        },
        {
            ...
            "description": {
                "type": "/type/text",
                "value": "Minor scanning error: pp. 190-191 are duplicated, pp. 206-207 are missing."
            },
            "last_modified": {
                "type": "/type/datetime",
...
<div id="books-view" ng-controller="consultBookController">
    <span class="image">
        <a href="#" title=""><img src={{book.cover.small}} alt="thumbmail"></a>
    </span>
    <span class="details">
        <h3>
            <a href="#" class="results"> {{book.title}} </a>
        </h3>
        <span class="small">
            by <a href="#" class="results">{{book.by_statement}}</a>
        </span>
        <span class="meta">
            <span class="type book small">edition</span> - eBook available
        </span>
    </span>
</div>